...
- Pendiente:
  - No hay limpieza periódica de archivos huérfanos en Supabase Storage (solo se limpia al publicar o cancelar; un crash a media subida puede dejar restos — mitigado parcialmente, ver `[31 Jul 2026] fix: prevención de archivo huérfano`).
  - Monitorización post-launch, posibles mejoras (batch /add, etc.).
